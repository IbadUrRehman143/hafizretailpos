        ...
        <div className="w-full max-w-3xl overflow-hidden rounded-3xl bg-white shadow-2xl">
          ...
          <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white px-6 py-5">
            ...
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full bg-slate-100 text-lg text-slate-600 hover:bg-slate-200 disabled:opacity-50"
            >
              ×
            </button>
          </div>
          ...
          <form
            onSubmit={onSubmit}
            className="max-h-[calc(100vh-120px)] space-y-6 overflow-y-auto p-6"
          >
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-2">
                ...
                <label className="block">
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm outline-none focus:border-slate-400 disabled:bg-slate-100"
                  >
                    <option value="">
                      Select Supplier
                    </option>
                  ...
                  {/* SELECTED SUPPLIER + DELETE */}

                  {selectedSupplier && (
                    <div className="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <div className="min-w-0 flex-1 rounded-lg bg-emerald-50 px-3 py-2 text-xs text-emerald-700">
                        Selected:{" "}
                        <strong>
                          {
                      ...
                      <button
                        ...
                        className="shrink-0 rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-xs font-semibold text-red-600 transition hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-50"
                      >
                        {deletingSupplier
                          ? "Deleting..."
                          : "Delete Supplier"}
