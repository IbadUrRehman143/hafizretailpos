...
export type StorageHash =
  StorageHashBase<'c6a87fcbd77524ad0d3a50835a20deb2aa76b2bf0abcff92ec7d0a84c872d425'>;
export type ExecutionHash =
  ExecutionHashBase<'a6ae4f5630e6a577ecd796fec28fe886b98356121033cefe982cba010ebe9ca8'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly AiAction: {
      ...
      readonly workflow: CodecTypes['pg/text@1']['output'];
      ...
      readonly decidedById: CodecTypes['pg/int4@1']['output'] | null;
      readonly decidedByName: CodecTypes['pg/text@1']['output'];
      ...
      readonly failureReason: CodecTypes['pg/text@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly AiKnowledgeChunk: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      ...
      readonly embeddingJson: CodecTypes['pg/text@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    ...
    readonly Customer: {
      ...
      readonly status: CodecTypes['pg/text@1']['output'];
      readonly openingBalance: CodecTypes['pg/float8@1']['output'];
      readonly creditLimit: CodecTypes['pg/float8@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly Expense: {
    ...
    readonly Product: {
      ...
      readonly categoryName: CodecTypes['pg/text@1']['output'];
    ...
    readonly Purchase: {
      ...
      readonly supplierBillNo: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly AiAction: {
      ...
      readonly workflow: CodecTypes['pg/text@1']['input'];
      ...
      readonly decidedById: CodecTypes['pg/int4@1']['input'] | null;
      readonly decidedByName: CodecTypes['pg/text@1']['input'];
      ...
      readonly failureReason: CodecTypes['pg/text@1']['input'];
    ...
    readonly AiKnowledgeChunk: {
      ...
      readonly embeddingJson: CodecTypes['pg/text@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly AiKnowledgeSource: {
      readonly id: CodecTypes['pg/int4@1']['input'];
    ...
    readonly Customer: {
      ...
      readonly status: CodecTypes['pg/text@1']['input'];
      readonly openingBalance: CodecTypes['pg/float8@1']['input'];
      readonly creditLimit: CodecTypes['pg/float8@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly Expense: {
    ...
    readonly Product: {
      ...
      readonly categoryName: CodecTypes['pg/text@1']['input'];
    ...
    readonly Purchase: {
      ...
      readonly supplierBillNo: CodecTypes['pg/text@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly aiKnowledgeChunk: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['sourceId', 'chunkIndex'] }];
              indexes: readonly [
                {
                  readonly name: 'aiKnowledgeChunk_sourceId_idx_d92a2571';
                  readonly prefix: 'aiKnowledgeChunk_sourceId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    ...
                    readonly tableName: 'aiKnowledgeChunk';
                    readonly columns: readonly ['sourceId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'aiKnowledgeSource';
            ...
            readonly aiKnowledgeSource: {
              columns: {
                ...
                readonly sourceType: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'NOTE'>;
                  };
                };
                readonly content: {
                  readonly nativeType: 'text';
            ...
            readonly product: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'product_subcategoryId_idx_d4b355f2';
                  readonly prefix: 'product_subcategoryId_idx';
...
> & {
  ...
  readonly roots: {
    ...
    readonly aiKnowledgeSource: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'AiKnowledgeSource';
    };
    readonly aiKnowledgeChunk: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'AiKnowledgeChunk';
    };
    readonly aiAction: { readonly namespace: 'public' & NamespaceId; readonly model: 'AiAction' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          readonly AiAction: {
            ...
            readonly storage: {
              readonly table: 'aiAction';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly workflow: { readonly column: 'workflow' };
                ...
                readonly decidedByName: { readonly column: 'decidedByName' };
          ...
          readonly AiKnowledgeChunk: {
            ...
            readonly storage: {
              readonly table: 'aiKnowledgeChunk';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
          ...
          readonly AiKnowledgeSource: {
            ...
            readonly storage: {
              readonly table: 'aiKnowledgeSource';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly title: { readonly column: 'title' };
          ...
          readonly Customer: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly status: { readonly column: 'status' };
                readonly openingBalance: { readonly column: 'openingBalance' };
          ...
          readonly Product: {
            ...
            readonly relations: {
              ...
              readonly inventoryTransactions: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'InventoryTransaction';
                };
          ...
          readonly Purchase: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly supplierBillNo: { readonly column: 'supplierBillNo' };
